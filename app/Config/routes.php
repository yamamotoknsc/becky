 ...
 */
	...
	Router::connect('/Index/feed/', array('controller' => 'index', 'action' => 'feed'));	
	...
	Router::connect('/List/:urlname/news/', array('controller' => 'news', 'action' => 'top'),array('pass'=>array('urlname','id')));		
	Router::connect('/List/:urlname/news/:id', array('controller' => 'news', 'action' => 'top'),array('pass'=>array('urlname','id')));			

	Router::connect('/List/*', array('controller' => 'list', 'action' => 'index'));	
