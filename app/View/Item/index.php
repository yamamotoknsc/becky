...
<a href="<?php echo WEBROOT.'item/?itemID='.$Item['Item']['id'];?>"><?php echo $Item['Item']['name'];?></a>
<a data-toggle="modal" class="btn btn-info" data-target="#voteModal" href="<?php echo $Item['Item']['id']?>">Click me !</a>
<!-- Modal -->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <iframe name="voteFrame" src="" width="100%" height="600" frameborder="0" allowtransparency="true"></iframe>
      </div>
...
$('a.btn').on('click', function(e) {
    ...
    $('.modal-body').html('<iframe width="100%" height="600" frameborder="0" scrolling="no" allowtransparency="true" src="<?php echo WEBROOT?>Vote/ItemReviewInput/?itemID=' + url + '"></iframe>');
});
</script>
